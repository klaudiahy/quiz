package com.example.klaudia.quizapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    //{"Country", "Right Answer", "Choice1", "Choice2", "Choice3"}
            {"China", "Bejing", "Jakarta", "Manila", "Stockholm"},
            {"India", "New Delhi", "Beijng", "Bangkok", "Seul"},
            {"Indonesia", "Jakarta", "Manila", "New Delhi", "Kuala Lupur"},
            {"Japan", "Tokyo", "Bangkok", "Taipei","Jakarta"},
            {"Thailand", "Bangkok", "Berlin", "Havana","Kingston"},
            {"Brazil", "Brasilia", "Havana", "Bangkok","Copenhagen"},
            {"Canada", "Ottawa", "Bern", "Copenghagen","Jakarta"},
            {"Cuba", "Havana", "Bern", "London","Mexico Cisty"},
            {"Mexico", "Mexico City", "Ottawa", "Berlin","Santiago"},
            {"United States", "Washington D.C.", "San Jose", "Buenos Aires","Kuala Lumpu"},
            {"France", "Paris", "Ottawa", "Copenghagen","Tokyo"},
